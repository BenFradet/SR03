...
SOAP_SOURCE_STAMP("@(#) soapServer.c ver 2.7.9k 2014-05-27 17:07:48 GMT")
...
{	struct ns2__add soap_tmp_ns2__add;
	...
	if (soap_body_end_in(soap)
	 ...
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = ns2__add(soap, soap_tmp_ns2__add.a, soap_tmp_ns2__add.b, &soap_tmp_double);
	if (soap->error)
		return soap->error;
...
{	struct ns2__sub soap_tmp_ns2__sub;
	...
	if (soap_body_end_in(soap)
	 ...
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = ns2__sub(soap, soap_tmp_ns2__sub.a, soap_tmp_ns2__sub.b, &soap_tmp_double);
	if (soap->error)
		return soap->error;
	soap_serializeheader(soap);
...
{	struct ns2__mul soap_tmp_ns2__mul;
	...
	if (soap_body_end_in(soap)
	 ...
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = ns2__mul(soap, soap_tmp_ns2__mul.a, soap_tmp_ns2__mul.b, &soap_tmp_double);
	if (soap->error)
		return soap->error;
	soap_serializeheader(soap);
...
{	struct ns2__div soap_tmp_ns2__div;
	...
	if (soap_body_end_in(soap)
	 ...
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = ns2__div(soap, soap_tmp_ns2__div.a, soap_tmp_ns2__div.b, &soap_tmp_double);
	if (soap->error)
		return soap->error;
	soap_serializeheader(soap);
...
{	struct ns2__pow soap_tmp_ns2__pow;
	...
	if (soap_body_end_in(soap)
	 ...
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = ns2__pow(soap, soap_tmp_ns2__pow.a, soap_tmp_ns2__pow.b, &soap_tmp_double);
	if (soap->error)
		return soap->error;
	soap_serializeheader(soap);
