...
SOAP_SOURCE_STAMP("@(#) soapServer.c ver 2.7.9k 2014-05-27 15:41:50 GMT")
...
{	struct ns__add soap_tmp_ns__add;
	...
	soap_tmp_ns__addResponse.response = &soap_tmp_double;
	...
	if (soap_body_end_in(soap)
	 ...
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = ns__add(soap, soap_tmp_ns__add.op1, soap_tmp_ns__add.op2, &soap_tmp_double);
	if (soap->error)
		return soap->error;
...
{	struct ns__sub soap_tmp_ns__sub;
	...
	soap_default_double(soap, &soap_tmp_double);
	soap_tmp_ns__subResponse.response = &soap_tmp_double;
	...
	if (soap_body_end_in(soap)
	 ...
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = ns__sub(soap, soap_tmp_ns__sub.op1, soap_tmp_ns__sub.op2, &soap_tmp_double);
	if (soap->error)
		return soap->error;
	soap_serializeheader(soap);
...
{	struct ns__mul soap_tmp_ns__mul;
	...
	soap_default_double(soap, &soap_tmp_double);
	soap_tmp_ns__mulResponse.response = &soap_tmp_double;
	...
	if (soap_body_end_in(soap)
	 ...
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = ns__mul(soap, soap_tmp_ns__mul.op1, soap_tmp_ns__mul.op2, &soap_tmp_double);
	if (soap->error)
		return soap->error;
	soap_serializeheader(soap);
...
{	struct ns__div soap_tmp_ns__div;
	...
	soap_default_double(soap, &soap_tmp_double);
	soap_tmp_ns__divResponse.response = &soap_tmp_double;
	...
	if (soap_body_end_in(soap)
	 ...
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = ns__div(soap, soap_tmp_ns__div.op1, soap_tmp_ns__div.op2, &soap_tmp_double);
	if (soap->error)
		return soap->error;
	soap_serializeheader(soap);
