...
SOAP_SOURCE_STAMP("@(#) soapC.c ver 2.7.9k 2014-05-27 15:41:50 GMT")
...
{
	(void)soap; (void)a; /* appease -Wall -Werror */
	soap_default_int(soap, &a->op1);
	soap_default_int(soap, &a->op2);
}
...
{
	soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns__div), type);
	soap_out_int(soap, "op1", -1, &a->op1, "");
	soap_out_int(soap, "op2", -1, &a->op2, "");
	soap_element_end_out(soap, tag);
	return SOAP_OK;
}
...
{
	short soap_flag_op1 = 1, soap_flag_op2 = 1;
	if (soap_element_begin_in(soap, tag, 0, type))
		return NULL;
	...
	if (soap->body && !*soap->href)
	{
		...
		{	soap->error = SOAP_TAG_MISMATCH;
			if (soap_flag_op1 && soap->error == SOAP_TAG_MISMATCH)
				if (soap_in_int(soap, "op1", &a->op1, "xsd:int"))
				{	soap_flag_op1--;
					continue;
				}
			if (soap_flag_op2 && soap->error == SOAP_TAG_MISMATCH)
				if (soap_in_int(soap, "op2", &a->op2, "xsd:int"))
				{	soap_flag_op2--;
					continue;
				}
			if (soap->error == SOAP_TAG_MISMATCH)
	...
	if ((soap->mode & SOAP_XML_STRICT) && (soap_flag_op1 > 0 || soap_flag_op2 > 0))
...
{
	(void)soap; (void)a; /* appease -Wall -Werror */
	soap_serialize_PointerTodouble(soap, &a->response);
}
...
{
	soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns__divResponse), type);
	soap_out_PointerTodouble(soap, "response", -1, &a->response, "");
	soap_element_end_out(soap, tag);
	return SOAP_OK;
}
	...
	if (soap->body && !*soap->href)
	{
		...
		{	soap->error = SOAP_TAG_MISMATCH;
			if (soap_flag_response && soap->error == SOAP_TAG_MISMATCH)
				if (soap_in_PointerTodouble(soap, "response", &a->response, "xsd:double"))
				{	soap_flag_response--;
					continue;
				}
			if (soap->error == SOAP_TAG_MISMATCH)
...
{
	soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns__mul), type);
	soap_out_int(soap, "op1", -1, &a->op1, "");
	soap_out_int(soap, "op2", -1, &a->op2, "");
	soap_element_end_out(soap, tag);
	return SOAP_OK;
...
{
	soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns__mulResponse), type);
	soap_out_PointerTodouble(soap, "response", -1, &a->response, "");
	soap_element_end_out(soap, tag);
	return SOAP_OK;
}
...
{
	soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns__sub), type);
	soap_out_int(soap, "op1", -1, &a->op1, "");
	soap_out_int(soap, "op2", -1, &a->op2, "");
	soap_element_end_out(soap, tag);
	return SOAP_OK;
...
{
	soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns__subResponse), type);
	soap_out_PointerTodouble(soap, "response", -1, &a->response, "");
	soap_element_end_out(soap, tag);
	return SOAP_OK;
}
